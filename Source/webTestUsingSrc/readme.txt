...
4. type emmake make -f makefile_test [-gx] to generate test_VCS.bc 
   where [-gx] could be -g0, -g1, -g2, -g3 or -g4
4. make sure libVCS.bc was generated correctly in WebVCS/Source/src folder
5. type 
emcc --memory-init-file 0 -s ALLOW_MEMORY_GROWTH=1 -s NO_EXIT_RUNTIME=1 -s DISABLE_EXCEPTION_CATCHING=0 test_VCS.bc -o test_VCS.html [-gx]
